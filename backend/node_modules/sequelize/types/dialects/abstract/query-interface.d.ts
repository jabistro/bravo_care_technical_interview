...
import {
    Attributes, CreationAttributes, Filterable, Logging,
    Model,
    ModelAttributeColumnOptions,
    ModelAttributes, ModelStatic,
    ModelType, Poolable, Transactionable,
    WhereOptions
} from 'sequelize/types/model';
import { RetryOptions, Sequelize } from 'sequelize/types/sequelize';
