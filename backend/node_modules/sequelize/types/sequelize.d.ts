...
import { ColumnsDescription, QueryInterface, QueryOptions, QueryOptionsWithModel, QueryOptionsWithType } from 'sequelize/types/dialects/abstract/query-interface';
...
import {
    AndOperator, Attributes, BulkCreateOptions, ColumnReference, CreateOptions, CreationAttributes, DestroyOptions,
    DropOptions,
    FindOptions, Hookable, InstanceDestroyOptions,
    Logging,
    Model,
    ModelAttributeColumnOptions,
    ModelAttributes, ModelCtor, ModelOptions, ModelType, OrOperator,
    UpdateOptions, WhereAttributeHashValue, WhereOperators
